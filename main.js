...
console.log("\nString Inclusion Test: Does '".concat(array.join(', '), "' contain '").concat(fruitToCheck, "'? I predict True."));
console.log(array.join(', ').includes(fruitToCheck));
var fruitToCheckNotIn = 'grape';
console.log("\nString Exclusion Test: Does '".concat(array.join(', '), "' not contain '").concat(fruitToCheckNotIn, "'? I predict True."));
